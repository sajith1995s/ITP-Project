...
{
    public partial class fm_income : fm_f_stats
    {
        Data data = new Data();
        public fm_income()
        {
        ...
        private void btnTable_Click(object sender, EventArgs e)
        {
            ...
            else // periodOfView = Monthly
            {
                ...
                if(cmbYear.SelectedIndex != 0)
                    table = data.GetIncome(displayMode, Convert.ToInt32(cmbYear.SelectedItem));
            }
        ...
        private void btnChart_Click(object sender, EventArgs e)
        {
            ...
            if (chartType == "Bar")
            {
                if (displayMode == "Separate")
                {
                    ...
                    chart1.Series.Add("Services");
                    chart1.Series.Add("Repairs");
